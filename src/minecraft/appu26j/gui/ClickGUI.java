...
public class ClickGUI extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
		...
		this.drawRect(i - 200, j - 125, i + 200, j + (this.selectedMod instanceof ToggleSprint ? 150 : 125), this.backgroundColour, (int) (this.index * 255));
		...
		if (this.selectedMod == null)
		{
			...
			{
				float f = i - 170;
				this.drawRect(f + categoryOffset, j - 100, (f + this.getStringWidth(category.name(), 8)) + 10 + categoryOffset, j - 80, !this.searching && this.isInsideBox(mouseX, mouseY, f + categoryOffset, j - 100, (f + this.getStringWidth(category.name(), 8)) + 10 + categoryOffset, j - 80) ? this.backgroundColourDarkened : this.backgroundColourLightened, (int) (this.index * 255));
			...
			this.drawRect(i + 55, j - 100, i + 160, j - 80, !this.searching && this.isInsideBox(mouseX, mouseY, i + 55, j - 100, i + 160, j - 80) ? this.backgroundColourDarkened : this.backgroundColourLightened, (int) (this.index * 255));
			...
			this.scissor(i - 200, j - 70, i + 200, j + 125, 0.85F + (this.index * 0.15F));
			...
			for (Mod mod : this.selectedCategory.equals(Category.ALL) ? Apple.CLIENT.getModsManager().getMods() : Apple.CLIENT.getModsManager().getMods(this.selectedCategory))
			{
				...
				this.drawRect((i - 170) + xOffset, (j - 80) + yOffset, (i - 170) + xOffset + 100, (j - 80) + yOffset + 100, !this.searching && this.isInsideBox(mouseX, mouseY, i - 200, j - 70, i + 200, j + 125) && this.isInsideBox(mouseX, mouseY, (i - 170) + xOffset, (j - 80) + yOffset, (i - 170) + xOffset + 100, (j - 80) + yOffset + 100) ? this.backgroundColourDarkened : this.backgroundColourLightened, (int) (this.index * 255));
				...
				this.drawRect((i - 170) + xOffset, (j - 5) + yOffset, (i - 170) + xOffset + 100, (j - 80) + yOffset + 100, (mod.isEnabled() ? (!this.searching && this.isInsideBox(mouseX, mouseY, i - 200, j - 70, i + 200, j + 125) && this.isInsideBox(mouseX, mouseY, (i - 170) + xOffset, (j - 80) + yOffset, (i - 170) + xOffset + 100, (j - 80) + yOffset + 100) ? new Color(0, 200, 75) : new Color(0, 225, 100)) : (!this.searching && this.isInsideBox(mouseX, mouseY, i - 200, j - 70, i + 200, j + 125) && this.isInsideBox(mouseX, mouseY, (i - 170) + xOffset, (j - 80) + yOffset, (i - 170) + xOffset + 100, (j - 80) + yOffset + 100) ? new Color(230, 0, 25) : new Color(255, 25, 50))).getRGB(), (int) (this.index * 255));
		...
		if (this.searching)
		{
			...
			this.drawRect(i - 100, 20, i + 100, 50, this.isInsideBox(mouseX, mouseY, i - 100, 20, i + 100, 50) ? this.backgroundColourDarkened : this.backgroundColour, (int) (this.index * 255));
			...
			for (Mod mod : this.searchingMessage.isEmpty() ? Apple.CLIENT.getModsManager().getMods() : Apple.CLIENT.getModsManager().getMods().stream().filter(mod -> mod.getName().toLowerCase().contains(this.searchingMessage.toLowerCase())).collect(Collectors.toCollection(ArrayList::new)))
			{
				...
				String[] names = mod.getName().split(" ");
				this.drawRect((i - 170) + xOffset, (80) + yOffset, (i - 170) + xOffset + 100, (80) + yOffset + 100, this.isInsideBox(mouseX, mouseY, 0, 70, this.width / this.zoomFactor, this.height / this.zoomFactor) && this.isInsideBox(mouseX, mouseY, (i - 170) + xOffset, (80) + yOffset, (i - 170) + xOffset + 100, (80) + yOffset + 100) ? this.backgroundColourDarkened : this.backgroundColourLightened, (int) (this.index * 255));
				this.drawStringAlpha(names[0], (i - 120) - (this.getStringWidth(names[0], 12) / 2) + xOffset, (100) + yOffset, 12, -1, (int) (this.index * 255));
				this.drawStringAlpha(names[1], (i - 120) - (this.getStringWidth(names[1], 12) / 2) + xOffset, (120) + yOffset, 12, -1, (int) (this.index * 255));
				this.drawRect((i - 170) + xOffset, (155) + yOffset, (i - 170) + xOffset + 100, (180) + yOffset, (mod.isEnabled() ? (this.isInsideBox(mouseX, mouseY, 0, 70, this.width / this.zoomFactor, this.height / this.zoomFactor) && this.isInsideBox(mouseX, mouseY, (i - 170) + xOffset, (80) + yOffset, (i - 170) + xOffset + 100, (80) + yOffset + 100) ? new Color(0, 200, 75) : new Color(0, 225, 100)) : (this.isInsideBox(mouseX, mouseY, 0, 70, this.width, this.height) && this.isInsideBox(mouseX, mouseY, (i - 170) + xOffset, (80) + yOffset, (i - 170) + xOffset + 100, (80) + yOffset + 100) ? new Color(230, 0, 25) : new Color(255, 25, 50))).getRGB(), (int) (this.index * 255));
				String text = mod.isEnabled() ? "ENABLED" : "DISABLED";
				this.drawStringAlpha(text, (i - 120) - (this.getStringWidth(text, 12) / 2) + xOffset, (162) + yOffset, 12, new Color(254, 254, 254).getRGB(), (int) (this.index * 255));
				xOffset += 115;
			}
