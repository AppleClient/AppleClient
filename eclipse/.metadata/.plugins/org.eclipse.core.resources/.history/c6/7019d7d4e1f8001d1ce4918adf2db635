...
public class DragGUI extends GuiScreen
{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
		...
		this.drawRect(i - 50, j - 12.5F, i + 50, j + 12.5F, this.isInsideBox(mouseX, mouseY, i - 50, j - 12.5F, i + 50, j + 12.5F) ? this.backgroundColourDarkened : this.backgroundColour, (int) (this.index * 255));
